// taken from Ben Fowler's script on Github
...
function playRound(playerSelection){
    ...
    (playerSelection == 'paper' && computerSelection == 'rock')){
        ...
        result = ('It\'s a tie.  You both chose ' + playerSelction + "<br><br>Player score: " + playerScore + '<br>Computer score: ' + computerScore)
    }
    else{
        computerScore += 1
